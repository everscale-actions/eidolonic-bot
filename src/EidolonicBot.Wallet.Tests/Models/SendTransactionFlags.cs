...
// todo: use from AppKit framework then released
/// <summary>
...
public enum SendTransactionFlags {
    ...
    /// <summary>
    ///     if there are some errors during the action phase it should be ignored (don't fail transaction e.g. if message balance is greater than
    ///     remaining balance, or it has invalid address)
    /// </summary>
    IgnoreSomeErrors = 2,
